    ...
    <div class="min-h-screen  bg-pink-50 ">
        ...
        <main>
            ...
            <div class=" text-center  grid grid-cols-3 mt-12">
                ...
                <a href="/recordend2" class=" bg-pink-200  rounded-lg  pt-1.5  ml-12"> เสร็จสิ้น </a>
            ...
            <div class=" bg-purple-100 h-52 w-80% mt-12 rounded-lg flex m-12">
                ...
                <div class=" grid grid-cols-2 ">
                    <a href="/recordcancel2" > <p class=" bg-blue-200 shadow-xl w-32 h-7 place-self-center text-center font-bold rounded-md mb-20"> ยกเลิก </p></a>
                    <a href="/recordend2" ><p class=" bg-pink-300 shadow-xl w-32 h-7 place-self-center text-center font-bold rounded-md mb-20"> ยืนยัน </p></a>
                </div>
        </main>
        <div class=" mt-12">
        <footter/>
